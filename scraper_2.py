...
# Webdriver
browser = webdriver.Edge("C:/Users/Paarvi/Downloads/PRO-C128-RefCode-main/msedgedriver.exe")
browser.get(START_URL)
## the computer would take 10 seconds (sleep) before extracting the data
time.sleep(10)

planets_data = []

##all the data we would like to extract 
